...
namespace PPC_Rental.Models
{
    ...
    public partial class PROPERTY
    {
        ...
        [Required(ErrorMessage = "Yêu c?u nh?p tên d? án ")]
        public string PropertyName { get; set; }
        public string Avatar { get; set; }
        public string Images { get; set; }
        public Nullable<int> PropertyType_ID { get; set; }
        [Display(Name = "Content")]
        [Required(ErrorMessage = "Yêu c?u nh?p mô t? cho d? án ")]
        ...
        [Display(Name = "Price")]
        [Required(ErrorMessage = "Yêu c?u nh?p giá")]
        public Nullable<int> Price { get; set; }
        public string UnitPrice { get; set; }
        [Display(Name = "Area")]
        [Required(ErrorMessage = "Yêu c?u nh?p di?n tích")]
        public string Area { get; set; }

        [Range(1, 100)]
        [Display(Name = "Bed")]
        [Required(ErrorMessage = "Yêu c?u nh?p s? ph?ng ng?")]
        public Nullable<int> BedRoom { get; set; }

        [Display(Name = "Bath")]
        [Required(ErrorMessage = "Yêu c?u nh?p s? ph?ng t?m")]
        public Nullable<int> BathRoom { get; set; }


        [Display(Name = "ParkingPlace")]
        [Required(ErrorMessage = "Yêu c?u nh?p s? ch? ð? xe")]
